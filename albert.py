...
class AlbertModelForRegression(nn.Module):
    def __init__(self, output_dim, dropout_rate=0.2):
        super(AlbertModelForRegression, self).__init__()
        self.albert = AlbertModel.from_pretrained('albert-base-v2')
        self.dropout = nn.Dropout(dropout_rate)
        self.fc = nn.Linear(self.albert.config.hidden_size, output_dim)

        # Freeze the ALBERT layers
...
model = AlbertModelForRegression(1).to(device)

# Unfreeze the ALBERT layers
